...
public class checkDetails {
    ...
    public void checkerMail(JFXTextField example, String column, JFXButton button) {
        escapeChar esc=new escapeChar();
     ...
     public void checkerid(JFXTextField example, String column, Button button) {
        escapeChar esc=new escapeChar();
