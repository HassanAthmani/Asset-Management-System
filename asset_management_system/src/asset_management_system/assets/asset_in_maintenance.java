...
public class asset_in_maintenance {
    ...
    //Constructor
    public asset_in_maintenance(String assetID, String assetName, String assetCode, String assetDetails, String workerName, String workerID,String categoryID,String additionDate,String maintenanceDate) {
        ...
        this.maintenanceDate = new SimpleStringProperty(maintenanceDate);
    ...
    public StringProperty maintenanceDateProperty() {
