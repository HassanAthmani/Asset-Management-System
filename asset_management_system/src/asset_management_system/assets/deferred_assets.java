...
public class deferred_assets {
    ...
    private final StringProperty deferredDate;
    private final StringProperty reason;

    //Constructor
    public deferred_assets(String assetID, String assetName, String assetCode, String assetDetails, String workerName, String workerID,String categoryID,String additionDate,String deferredDate,String reason) {
        ...
        this.deferredDate = new SimpleStringProperty(deferredDate);
    ...
    public void setAdditionDate(String Value) {
     ...
     public void setDeferredDate(String Value) {
        deferredDate.set(Value);
    }     
    ...
    public StringProperty deferredDateProperty() {
        return deferredDate;
    }
